...
توجه : داکیومنت زیر بر اساس اصول مهندسی پرامپت ،‌برای همکاری با مدل های زبانی بهینه شده است . به همین علت ساختاری کمی متفاوت از داکیومنت های قدیمی و مرسوم دارد.  
